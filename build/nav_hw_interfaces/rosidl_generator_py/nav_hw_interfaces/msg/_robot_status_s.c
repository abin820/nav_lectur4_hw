...
bool nav_hw_interfaces__msg__robot_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("nav_hw_interfaces.msg._robot_status.RobotStatus", full_classname_dest, 47) == 0);
  }
  nav_hw_interfaces__msg__RobotStatus * ros_message = _ros_message;
  {  // name
...
PyObject * nav_hw_interfaces__msg__robot_status__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("nav_hw_interfaces.msg._robot_status");
