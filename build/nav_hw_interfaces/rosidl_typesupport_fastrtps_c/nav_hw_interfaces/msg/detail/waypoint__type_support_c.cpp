...
#include "nav_hw_interfaces/msg/detail/waypoint__rosidl_typesupport_fastrtps_c.h"
...
#include "nav_hw_interfaces/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_nav_hw_interfaces
...
using _Waypoint__ros_msg_type = nav_hw_interfaces__msg__Waypoint;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav_hw_interfaces
size_t get_serialized_size_nav_hw_interfaces__msg__Waypoint(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Waypoint__ros_msg_type * ros_message = static_cast<const _Waypoint__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Waypoint__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_nav_hw_interfaces__msg__Waypoint(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_nav_hw_interfaces
size_t max_serialized_size_nav_hw_interfaces__msg__Waypoint(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav_hw_interfaces__msg__Waypoint;
    is_plain =
      (
...
static size_t _Waypoint__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_nav_hw_interfaces__msg__Waypoint(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, nav_hw_interfaces, msg, Waypoint)() {
