...
#include "nav_hw_interfaces/msg/detail/robot_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_nav_hw_interfaces
cdr_serialize(
  const nav_hw_interfaces::msg::RobotStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  nav_hw_interfaces::msg::RobotStatus & ros_message)
{
  // Member: name
  cdr >> ros_message.name;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = nav_hw_interfaces::msg::RobotStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const nav_hw_interfaces::msg::RobotStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<nav_hw_interfaces::msg::RobotStatus *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_nav_hw_interfaces
const rosidl_message_type_support_t *
get_message_type_support_handle<nav_hw_interfaces::msg::RobotStatus>()
{
  return &nav_hw_interfaces::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, nav_hw_interfaces, msg, RobotStatus)() {
  return &nav_hw_interfaces::msg::typesupport_fastrtps_cpp::_RobotStatus__handle;
}
