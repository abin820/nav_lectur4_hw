...
{
  new (message_memory) nav_hw_interfaces::msg::Waypoint(_init);
}

void Waypoint_fini_function(void * message_memory)
{
  auto typed_message = static_cast<nav_hw_interfaces::msg::Waypoint *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Waypoint_message_member_array[4] = {
  {
    ...
    offsetof(nav_hw_interfaces::msg::Waypoint, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav_hw_interfaces::msg::Waypoint, x),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav_hw_interfaces::msg::Waypoint, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(nav_hw_interfaces::msg::Waypoint, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Waypoint_message_members = {
  ...
  4,  // number of fields
  sizeof(nav_hw_interfaces::msg::Waypoint),
...
get_message_type_support_handle<nav_hw_interfaces::msg::Waypoint>()
{
  return &::nav_hw_interfaces::msg::rosidl_typesupport_introspection_cpp::Waypoint_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, nav_hw_interfaces, msg, Waypoint)() {
  return &::nav_hw_interfaces::msg::rosidl_typesupport_introspection_cpp::Waypoint_message_type_support_handle;
}
